...
namespace PeruStar.API.Follower.Interfaces.Rest.Controllers
{
    [ApiController]
    ...
    public class FollowerController:ControllerBase
    {
        ...
        public async Task<IEnumerable<ArtistResource>> GetAllAsync()
        {
            ...
            var resources = _mapper.Map<IEnumerable<Domain.Models.Follower>, IEnumerable<ArtistResource>>(follower);
            return resources;
        }
        ...
        public async Task<IEnumerable<FollowerResource>> GetAllByArtistIdAsync(long artistId)
        {
            ...
            var resources = _mapper.Map<IEnumerable<Domain.Models.Follower>, IEnumerable<FollowerResource>>(followers);
            return resources;
        }
