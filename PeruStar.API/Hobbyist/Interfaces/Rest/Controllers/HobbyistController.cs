...
public class HobbyistController : ControllerBase
{
        ...
        public async Task<IEnumerable<HobbyistResource>> GetAllAsync() {
            ...
            var resources = _mapper.Map<IEnumerable<Domain.Models.Hobbyist>, IEnumerable<HobbyistResource>>(hobbyist);
            return resources;
        }
        ...
        public async Task<IActionResult> PostAsync([FromBody] SaveHobbyistResource resource) {
            ...
            var hobbyist = _mapper.Map<SaveHobbyistResource, Domain.Models.Hobbyist>(resource);
