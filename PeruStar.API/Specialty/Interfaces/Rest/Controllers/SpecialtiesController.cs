...
public class SpecialtiesController : ControllerBase
{
    ...
    public async Task<IEnumerable<SpecialtyResource>> GetAllAsync()
    {
        ...
        var resources = _mapper.Map<IEnumerable<Domain.Models.Specialty>, IEnumerable<SpecialtyResource>>(specialty);
        return resources;
    }
    ...
    public async Task<IActionResult> GetByIdAsync(long specialtyId)
    {
        ...
        var specialtyResource = _mapper.Map<Domain.Models.Specialty, SpecialtyResource>(result.Resource);
    ...
    public async Task<IActionResult> PostAsync([FromBody] SaveSpecialtyResource resource)
    {
        ...
        var specialty = _mapper.Map<SaveSpecialtyResource, Domain.Models.Specialty>(resource);
